  ...
  const handleNextButton = async () => {
    try {
      ...
      if (response?.data?.document !== undefined) {
        ...
        if (concatenatedFields.address_vehicle_owner) {
          concatenatedFields.address_vehicle_owner = rearrangeAddress(
            concatenatedFields.address_vehicle_owner
          );
        }
        ...
        setData({
          ...data,
          ...concatenatedFields,
          address_vehicle_owner: rearrangeAddress(
            concatenatedFields.address_vehicle_owner
          ),          
        });
